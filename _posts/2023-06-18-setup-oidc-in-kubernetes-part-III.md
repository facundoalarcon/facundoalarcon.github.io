---
layout: post
title:  "Setup OIDC in Kubernetes clusters - Part III"
date:   2023-06-18 20:43:00 -0300
categories: kubernetes authentication authorization eks
---
In this post we will discuss how to setup OIDC in GKE clusters, in previous post we discuss about [Kubernetes OIDC]({{ site.baseurl }}{% link _posts/2023-06-18-setup-oidc-in-kubernetes-part-I.md %}) and the configuration on [EKS]({{ site.baseurl }}{% link _posts/2023-06-18-setup-oidc-in-kubernetes-part-II.md %}).
...
```
for example, from the previous post you can use *http://localhost:4040* for the redirect uri, and *http://localhost:4040/ad_username*, and *http://localhost:4040/ad_groups* for claims based on the [Part I]({{ site.baseurl }}{% link _posts/2023-06-18-setup-oidc-in-kubernetes-part-I.md %}).
...
You can use the google cloud CLI or [kubelogin]({{ site.baseurl }}{% link _posts/2023-06-18-setup-oidc-in-kubernetes-part-I.md %}).
